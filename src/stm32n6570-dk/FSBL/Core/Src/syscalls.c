...
int __io_putchar(int c)
{
  ...
  if (!__HAL_RCC_USART1_IS_CLK_ENABLED() || !LL_USART_IsEnabled(huart1.Instance))
    return c;

  while (!LL_USART_IsActiveFlag_TXE(huart1.Instance))
  {
  }
  LL_USART_TransmitData8(huart1.Instance, c);
