...
static model_data_type_t tensor_e0[1][64][1][32] __attribute__((section(".dtcm"))) __attribute__((aligned(16)));
static model_data_type_t tensor_e1[1][64][1][16] __attribute__((section(".dtcm"))) __attribute__((aligned(16)));
static model_data_type_t tensor_e2[1][64][1][8] __attribute__((section(".dtcm"))) __attribute__((aligned(16)));
static model_data_type_t tensor_e3[1][64][1][8] __attribute__((section(".dtcm"))) __attribute__((aligned(16)));
static model_data_type_t tensor_emb[1][1][512] __attribute__((section(".dtcm"))) __attribute__((aligned(16)));
...
static void randomize(model_data_type_t *array, size_t size_bytes)
{
  ...
  {
    array[i] = i / ((model_data_type_t)INT_MAX + 1);
  }
}
...
void model_benchmark()
{
  ...
  randomize((model_data_type_t *)tensor_feat_erb, sizeof(tensor_feat_erb));
  randomize((model_data_type_t *)tensor_feat_spec, sizeof(tensor_feat_spec));
  randomize((model_data_type_t *)tensor_e0, sizeof(tensor_e0));
  randomize((model_data_type_t *)tensor_e1, sizeof(tensor_e1));
  randomize((model_data_type_t *)tensor_e2, sizeof(tensor_e2));
  randomize((model_data_type_t *)tensor_e3, sizeof(tensor_e3));
  randomize((model_data_type_t *)tensor_emb, sizeof(tensor_emb));
  randomize((model_data_type_t *)tensor_c0, sizeof(tensor_c0));
  randomize((model_data_type_t *)tensor_lsnr, sizeof(tensor_lsnr));
  randomize((model_data_type_t *)tensor_m, sizeof(tensor_m));
  randomize((model_data_type_t *)tensor_coefs, sizeof(tensor_coefs));
  ...
  for (size_t i = 0; i < sizeof(counters) / sizeof(counters[0]); i++)
  {
    ...
    deepfilternet_run_erb_dec(tensor_emb, tensor_e3, tensor_e2, tensor_e1, tensor_e0, tensor_m);
